...
Engine::SpriteAnimationPlayer::SpriteAnimationPlayer(Entity& entity, const std::unordered_map<std::string, SpriteAnimation>& animations)
  : _entity(entity), _animations(animations) {}

void Engine::SpriteAnimationPlayer::play(int delta_time, const std::string& animation_id) {
